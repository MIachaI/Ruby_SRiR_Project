...
class TestCodeValidator < Test::Unit::TestCase
  ...
  # Check the regular output from known pattern
...
', CollectAndComparePrograms.new().compareFiles)
  ...
  # Check if there is a directory - if there is - the program continues to expected output
...
', CollectAndComparePrograms.new().checkFolder('files'))
  ...
  # Check if program counts files correctly
  def test_countFiles
    folderName ='files'
